...
Xtrain_path = "hf://datasets/Sandhya777/WellnessTourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/Sandhya777/WellnessTourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/Sandhya777/WellnessTourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/Sandhya777/WellnessTourism-Package-Prediction/ytest.csv"
...
# Save best model
joblib.dump(best_model, "best_wellness_package_prediction_model.joblib")

# Upload to Hugging Face
repo_id = "Sandhya777/wellness-package-prediction-model"
repo_type = "model"
...
api.upload_file(
    path_or_fileobj="best_wellness_package_prediction_model.joblib",
    path_in_repo="best_wellness_package_prediction_model.joblib",
    repo_id=repo_id,
    repo_type=repo_type,
)
